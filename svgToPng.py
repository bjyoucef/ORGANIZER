...
sourceDir = "/Users/youcef-badjadi/Coding/ui/icons"
distDir = "/Users/youcef-badjadi/Coding/ui/icons/png"
...
print("======================================================")
print('{0} files are tried to convert. {1} files are succeeded. {2} files are failed.'.format(len(convertList), success,
                                                                                              error))
print("======================================================")